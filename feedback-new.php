...
<html lang="en">
    <head>
        ...
        <title>Feedback Form HTML </title>
    ...
    <body >
                ...
                <div class="col-md-6 col-md-offset-3 form-container">
                    ...
                    <p> Please provide your feedback below: </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                <input type="submit"  value= "Post"class="btn btn-lg btn-warning btn-block" />
                            </div>
        ...
        <?php
            include "retrieve_data.php";                              // Using database connection file here

            $records = mysqli_query($db,"select * from feedback_db"); // fetch data from database
